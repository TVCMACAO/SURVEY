...
from .views import (
    ...
    SurveyGroupListCreate, SurveyGroupRetrieveUpdateDestroy, SurveyGroupSmtpTest, SurveyGroupSmsTest,
    ...
    SurveyAttendanceConsult, SurveyAttendanceVerify, SurveyAttendanceTicketDeliver,
...
urlpatterns = [
    ...
    path('groups/<str:pk>/sms-test/', SurveyGroupSmsTest.as_view(), name='surveygroup-sms-test'),
    ...
    path('surveys/<str:pk>/attendance/consult/', SurveyAttendanceConsult.as_view(), name='survey-attendance-consult'),
